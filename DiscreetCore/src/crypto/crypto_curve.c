/*
Code generated by MakeOps.py. 
Original code based on Daniel J. Bernstein's ref10 SUPERCOP.
Modifications and new functions based on Monero.
Many thanks to all.

Copyright 2021, Discreet Foundation.

Files can be reproduced and redistributed freely.
