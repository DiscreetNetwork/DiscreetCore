...
namespace discore {
    ...
    //for private ctkey:
    //  dest is seckey of the address;
    //  mask is a, where C = aG + bH (pedersen commitment amount)
    //for public key: 
    //  dest = P (the address)
    ...
    //to pass amount to receiver securely.
    //for a confidential 
    struct ecdhtuple {
        key mask;
        key amount;
    ...
    // wrapper for precomp group elements.
    struct geDsmp {
        ge_dsmp k;
    };
    ...
    /* constants defined by Dr. Sarang Noether. */
